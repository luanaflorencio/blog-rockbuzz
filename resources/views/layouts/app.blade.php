...
<head>
    ...
    <title>{{ config('app.name', 'Blog Rockbuzz') }}</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}" style="color: white;">{{ __('Cadastro') }}</a>
                                </li>
                            @endif
                        @else
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/posts">Minhas Publicações</a>
